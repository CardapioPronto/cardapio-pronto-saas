        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/carreiras" className="text-gray-300 hover:text-white transition-colors">
                  Carreiras
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/cardapio-digital" className="text-gray-300 hover:text-white transition-colors">
                  Cardápio Digital
                </Link>
              </li>
              <li>
