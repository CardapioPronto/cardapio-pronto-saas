...
import { 
  Users, Settings, CreditCard, Home, BarChart3, Shield, List, Database, Layers, BookOpen, Mail, MailOpen, MessageCircle, Send
} from "lucide-react";
...
const AdminLayout = ({ children, title }: AdminLayoutProps) => {
  ...
  const menuItems = [
    ...
    { icon: CreditCard, label: "Pagar.me", href: "/admin/pagarme" },
