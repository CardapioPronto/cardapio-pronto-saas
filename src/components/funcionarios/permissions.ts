...
export const PERMISSION_LABELS: Record<PermissionType, string> = {
  ...
  settings_integrations_manage: "Gerenciar Integracoes",
...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { value: "settings_system_manage", label: "Editar Sistema", description: "Alterar preferencias operacionais e impressao" },
      { value: "settings_integrations_manage", label: "Gerenciar Integracoes", description: "Acessar configuracoes de WhatsApp, iFood e pagamentos" },
      { value: "settings_audit_view", label: "Ver Auditoria", description: "Consultar historico de alteracoes em configuracoes e usuario" },
      { value: "settings_manage", label: "Gerenciar Tudo", description: "Permissao legada com acesso total as configuracoes" },
