...
export const supabaseConfigError: Error | null =
  !SUPABASE_URL || !SUPABASE_PUBLISHABLE_KEY
    ? new Error(
        "Supabase environment variables are not configured. Configure VITE_SUPABASE_URL e VITE_SUPABASE_PUBLISHABLE_KEY no painel do Lovable em Project Settings > Environment.",
      )
    : null;
