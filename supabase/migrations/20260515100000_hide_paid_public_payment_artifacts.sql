-- =====================================================================
-- I3 — Tracking público sem expor artefatos de pagamento após pagamento.
--
-- `get_public_order_tracking` continua retornando o status público do
-- pedido, mas QR PIX / copia-e-cola / checkout_url só ficam disponíveis
-- enquanto o pagamento está pendente. Depois de `paid_at` preenchido ou
-- status pago/capturado, esses campos são mascarados como NULL.
-- =====================================================================
...
COMMENT ON FUNCTION public.get_public_order_tracking(uuid) IS
  'Tracking público sanitizado; artefatos de pagamento ficam visíveis apenas enquanto pendentes.';
