-- Customer-facing subscription list should show the current commercial state,
-- not every canceled checkout attempt generated during card/Pagar.me retries.
...
COMMENT ON FUNCTION public.get_my_subscription_summaries(uuid) IS
  'Resumo das assinaturas vigentes ou pendentes do restaurante, sem histórico de tentativas canceladas.';
